    ...
    if len(message.command) != 2:
        if message.from_user.id not in ADMINS: 
            buttons = [[
             ...
             InlineKeyboardButton("For Update", url="https://t.me/cinemahub1000"),
             InlineKeyboardButton("For Movies", url="https://t.me/cinemahub00")
             ]]
        else:
            buttons = [[
             InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
        ...
        FORCES=["https://telegra.ph/file/4120618577a2ae39c5f29.jpg"]
